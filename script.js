...
// CREATES USER NAME "Sai Sapura Chewae" --> ssc
...
// const max = movements.reduce(function (accumulator, mov) {
//   if (accumulator > mov) return accumulator;
//   else return mov;
// }, movements [0])
// console.log(max);
...
const total =  movements.filter(mov => mov > 0)
.map(mov => mov * euroToUSD1)
